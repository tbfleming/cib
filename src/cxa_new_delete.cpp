...
*/
__attribute__((__visibility__("default"))) void* operator new(std::size_t size)
...
*/
__attribute__((__visibility__("default"))) void* operator new[](size_t size)
#if !__has_feature(cxx_noexcept)
    throw(std::bad_alloc)
#endif
{
...
*/
__attribute__((__visibility__("default"))) void operator delete(void* ptr)
#if __has_feature(cxx_noexcept)
    noexcept
#else
    throw()
